package meh.shuuphe.originsdimension.entity.ability.varasuchus;
...
public class Varasuchus extends PathAwareEntity implements GeoEntity {
    ...
    private static final RawAnimation SWIM  = RawAnimation.begin().thenLoop("animation.varasuchus.swim_move");
    private static final RawAnimation SWIM_IDLE = RawAnimation.begin().thenLoop("animation.varasuchus.swim_idle");
    private static final RawAnimation HURT  = RawAnimation.begin().thenPlayAndHold("animation.varasuchus.hurt");
    private static final RawAnimation DIE   = RawAnimation.begin().thenPlayAndHold("animation.varasuchus.die");

    public Varasuchus(EntityType<? extends PathAwareEntity> type, World world) {
        super(type, world);
    }
